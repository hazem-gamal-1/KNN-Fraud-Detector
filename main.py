...
if __name__ == '__main__':
    ...
    X_test, Y_test = prepare_and_load_data('test.csv')
    ...
    path=r"C:\Users\M.C 28-06-2023\Desktop\ML homework\Projects\project 3 Fraud Detection with KNN\config_and_results.json"
